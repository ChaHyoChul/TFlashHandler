...
/* Mini-TCP's API emulates sockets wherever it's possible to do so
 * without taking a huge efficency hit. To this end, we use some objects
...
struct msocket
{
   ...
   struct tcpcb * tp;      /* back pointer to TCP control block (tcpcb) structure */
...
//FSL Blocking and non-blocking of socket information:
//	http://publib.boulder.ibm.com/infocenter/systems/index.jsp?topic=/com.ibm.aix.progcomm/doc/progcomc/skt_xfr.htm 
//	Look for "Socket I/O Modes" at bottom of page.
