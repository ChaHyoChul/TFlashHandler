 ...
 */
void __declspec(standard_abi) asm_exception_handler(void);
int  __declspec(standard_abi) asm_set_ipl (uint32);
void __declspec(standard_abi) mcf5xxx_exe_wdebug (void *);
void __declspec(standard_abi) mcf5xxx_wr_sr (uint32);
void __declspec(standard_abi) mcf5xxx_wr_cacr (uint32);
void __declspec(standard_abi) mcf5xxx_wr_asid (uint32);
void __declspec(standard_abi) mcf5xxx_wr_acr0 (uint32);
void __declspec(standard_abi) mcf5xxx_wr_acr1 (uint32);
void __declspec(standard_abi) mcf5xxx_wr_acr2 (uint32);
void __declspec(standard_abi) mcf5xxx_wr_acr3 (uint32);
void __declspec(standard_abi) mcf5xxx_wr_mmubar (uint32);
void __declspec(standard_abi) mcf5xxx_wr_other_a7 (uint32);
//void __declspec(standard_abi) mcf5xxx_wr_other_sp (uint32);
void __declspec(standard_abi) mcf5xxx_wr_vbr (uint32);
void __declspec(standard_abi) mcf5xxx_wr_macsr (uint32);
void __declspec(standard_abi) mcf5xxx_wr_mask (uint32);
void __declspec(standard_abi) mcf5xxx_wr_acc0 (uint32);
void __declspec(standard_abi) mcf5xxx_wr_accext01 (uint32);
void __declspec(standard_abi) mcf5xxx_wr_accext23 (uint32);
void __declspec(standard_abi) mcf5xxx_wr_acc1 (uint32);
void __declspec(standard_abi) mcf5xxx_wr_acc2 (uint32);
void __declspec(standard_abi) mcf5xxx_wr_acc3 (uint32);
void __declspec(standard_abi) mcf5xxx_wr_pc (uint32);
void __declspec(standard_abi) mcf5xxx_wr_rombar0 (uint32);
void __declspec(standard_abi) mcf5xxx_wr_rombar1 (uint32);
void __declspec(standard_abi) mcf5xxx_wr_rambar0 (uint32);
void __declspec(standard_abi) mcf5xxx_wr_rambar1 (uint32);
void __declspec(standard_abi) mcf5xxx_wr_mpcr (uint32);
void __declspec(standard_abi) mcf5xxx_wr_secmbar (uint32);
//void __declspec(standard_abi) mcf5xxx_wr_mbar1 (uint32);
void __declspec(standard_abi) mcf5xxx_wr_mbar (uint32);
//void __declspec(standard_abi) mcf5xxx_wr_mbar0 (uint32);
void __declspec(standard_abi) mcf5xxx_byterev (uint32);
...
void mcf5xxx_irq_wd_enable (void);
