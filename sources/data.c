...
static POINT_DATA g_PointData[MAX_POINT_DATA] = {
	0,
};
...
void reset_point_data()
{
	...
	// Load
	set_point_data_from(3, 89.5, 180.0, 0.0);
	// Aspirate
	...
	// 작업 대기 위치
	set_point_data_from(15, 89.5, 1.0, 0.0);
}
