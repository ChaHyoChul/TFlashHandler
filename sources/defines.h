...
// #define SOFTWARE_VERSION "TFLASK-H 1.5.5-c" // 0128-0900. Origin complete가 false 이면, encoder 체크 하지 않는다. 
...
// #define SOFTWARE_VERSION "TFLASK-H 3.1.0-working" // 
...
#define SOFTWARE_VERSION "TFLASK-H 3.2.0-working" // 
